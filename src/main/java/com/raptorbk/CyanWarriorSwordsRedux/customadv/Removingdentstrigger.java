...
public class Removingdentstrigger extends AbstractCriterionTrigger<Removingdentstrigger.Instance> {
    ...
    @Override
    protected Removingdentstrigger.Instance createInstance(JsonObject json, EntityPredicate.AndPredicate entityPredicate, ConditionArrayParser conditionsParser) {
