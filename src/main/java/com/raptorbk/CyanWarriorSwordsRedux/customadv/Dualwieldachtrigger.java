...
public class Dualwieldachtrigger extends SimpleCriterionTrigger<Dualwieldachtrigger.Instance> {
    ...
    @Override
    protected Dualwieldachtrigger.Instance createInstance(JsonObject json, EntityPredicate.Composite entityPredicate, DeserializationContext conditionsParser) {
