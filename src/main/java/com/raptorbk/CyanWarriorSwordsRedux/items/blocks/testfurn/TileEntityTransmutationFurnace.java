...
import com.raptorbk.CyanWarriorSwordsRedux.items.blocks.testfurn.slots.SlotTransmutationFurnaceFuel;
...
public class TileEntityTransmutationFurnace extends TileEntityLockable implements ITickable, ISidedInventory
{
	...
	{
		return this.hasCustomName() ? this.furnaceCustomName : "container.transmutation_furnace";
	}
	...
	{
		fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityTransmutationFurnace.class, new String[] {"Items"}));
	}
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                TransmutationFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = TransmutationFurnaceRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = TransmutationFurnaceRecipes.instance().getCookingResult(itemstack);
            ItemStack itemstack2 = this.furnaceItemStacks.get(2);

            if (itemstack2.isEmpty())
            {
                if(itemstack.getItem() instanceof COMBUSTION_SWORD || itemstack.getItem() instanceof ICE_SWORD || itemstack.getItem() instanceof WILD_NATURE || itemstack.getItem() instanceof WIND_IMPULSE || itemstack.getItem() instanceof THUNDER_SHOCK || itemstack.getItem() instanceof DARK_NETHER || itemstack.getItem() instanceof LIGHT_NETHER || itemstack.getItem() instanceof ENDER_PORTAL || itemstack.getItem() instanceof GOLEM_SWORD){
                    itemstack1.setCount(2);
                }
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack) 
    {
    	...
    	{
    		ItemStack itemStack = this.furnaceItemStacks.get(1);
    		return isItemFuel(stack) || SlotTransmutationFurnaceFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
    	}
    }
    ...
    {
    	return "cwsr:transmutation_furnace";
    }
    
    @Override
    public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) 
    {
    	return new ContainerTransmutationFurnace(playerInventory, this);
    }
