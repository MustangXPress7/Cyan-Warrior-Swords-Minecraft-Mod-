...
public class SYNERGY_TOTEM extends Item {
    ...
    public ActionResult<ItemStack> use(World world, PlayerEntity entity, Hand handIn) {
        ...
        ITextComponent chatMessage=new TranslationTextComponent("chat.cwsr.usage.activation.dw");
        if(!world.isClientSide()) {
            entity.sendMessage(chatMessage,entity.getUUID());
        }

        return new ActionResult<>(ActionResultType.SUCCESS, active_totemStack);
    }
