...
public class TransmutationFurnaceTileEntities {
        public static final DeferredRegister<BlockEntityType<?>> TILE_ENTITIES = DeferredRegister.create(ForgeRegistries.BLOCK_ENTITY_TYPES, CyanWarriorSwordsReduxMod.MOD_ID);
